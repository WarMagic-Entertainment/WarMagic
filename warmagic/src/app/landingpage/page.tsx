    ...
    return (
        ...
        >
            ...
            <div className="absolute left-[150px] top-3/7 text-white">
                ...
                <Link href="/lobby"><button className="mt-8 px-10 py-4 text-[17px] text-white transition-all duration-300 bg-[var(--custom-yellow)] hover:bg-[#ebbc6c]">Play</button></Link>
            </div>
        </section>
    )
}